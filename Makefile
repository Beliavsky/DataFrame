...
obj    = kind.o util.o constants.o random.o basic_stats.o xacf.o xbasic_stats.o xcbind.o dataframe.o xdataframe_append.o xdataframe_loc.o table.o table_stats.o dataframe_stats.o xdataframe_stats.o xxdataframe_stats.o xdataframe.o prob_dist.o xreturns_dist.o xtable.o xtable_stats.o xxtable.o xutil.o xxdataframe.o xdataframe_indexing.o xdataframe_drop.o xdataframe_ops.o xdataframe_select.o xdataframe_align_ops.o xdataframe_sort_index.o xdataframe_reindex.o
...
xdataframe_indexing_gfort.exe: kind.o util.o dataframe.o xdataframe_indexing.o
	$(FC) -o xdataframe_indexing_gfort.exe kind.o util.o dataframe.o xdataframe_indexing.o $(FFLAGS)
...
xdataframe_select_gfort.exe: kind.o util.o dataframe.o xdataframe_select.o
	$(FC) -o xdataframe_select_gfort.exe kind.o util.o dataframe.o xdataframe_select.o $(FFLAGS)

xdataframe_align_ops_gfort.exe: kind.o util.o dataframe.o xdataframe_align_ops.o
	$(FC) -o xdataframe_align_ops_gfort.exe kind.o util.o dataframe.o xdataframe_align_ops.o $(FFLAGS)

xdataframe_sort_index_gfort.exe: kind.o util.o dataframe.o xdataframe_sort_index.o
	$(FC) -o xdataframe_sort_index_gfort.exe kind.o util.o dataframe.o xdataframe_sort_index.o $(FFLAGS)

xdataframe_reindex_gfort.exe: kind.o util.o dataframe.o xdataframe_reindex.o
	$(FC) -o xdataframe_reindex_gfort.exe kind.o util.o dataframe.o xdataframe_reindex.o $(FFLAGS)
...
run: $(executables)
	...
	./xdataframe_select_gfort.exe
	./xdataframe_align_ops_gfort.exe
	./xdataframe_sort_index_gfort.exe
	./xdataframe_reindex_gfort.exe

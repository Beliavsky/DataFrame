...
obj    = kind.o util.o constants.o random.o basic_stats.o xacf.o xbasic_stats.o xcbind.o dataframe.o xdataframe_append.o xdataframe_loc.o table.o table_stats.o dataframe_stats.o xdataframe_stats.o xxdataframe_stats.o xdataframe.o prob_dist.o xreturns_dist.o xtable.o xtable_stats.o xxtable.o xutil.o xxdataframe.o xdataframe_indexing.o xdataframe_drop.o xdataframe_ops.o xdataframe_select.o
